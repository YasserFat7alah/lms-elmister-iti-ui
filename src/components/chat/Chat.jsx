          ...
          md:translate-x-0 md:relative md:w-1/3 md:flex`}
            >
                ...
                <div className="space-y-3 flex-1 overflow-y-auto">
                    {/* AI Support Contact - Always First */}
                    <div
                        onClick={() => handleSelectTeacher({
                            id: 'ai-support',
                            name: 'El Mister AI Support',
                            avatar: null,
                            specialization: 'AI Assistant',
                            isAI: true
                        })}
                        className={`flex items-center p-3 rounded-lg cursor-pointer border-2 border-pink-200 bg-gradient-to-r from-pink-50 to-purple-50 hover:from-pink-100 hover:to-purple-100 transition-all
              ${activeSelectedTeacher?.id === 'ai-support' ? "ring-2 ring-[#FF0055]" : ""}`}
                    >
                        <Avatar className="w-10 h-10 ring-2 ring-pink-300">
                            <AvatarFallback className="text-md font-bold bg-gradient-to-br from-[#FF0055] to-purple-600 text-white">
                                🤖
                            </AvatarFallback>
                        </Avatar>
                        <div className="ml-3 flex-1">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] px-2 py-0.5 bg-gradient-to-r from-[#FF0055] to-purple-600 text-white rounded-full font-medium">
                                    AI
                                </span>
                            </div>
                            <p className="text-xs text-gray-500">Get instant help from our AI assistant</p>
                        </div>
                    </div>
