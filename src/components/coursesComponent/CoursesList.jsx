...
const CoursesList = ({ courses, currentPage, totalPages, onPageChange }) => {
  // const itemsPerPage = 12; // Handled by backend

  // const paginatedCourses = useMemo(() => { ... }); // Removed: data is already paginated
