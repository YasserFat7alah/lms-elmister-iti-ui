            ...
            <div className="lg:col-span-3 bg-black flex items-center justify-center min-h-[320px] relative group overflow-hidden">
              {videoUrl ? (
                ...
                <div className="relative w-full h-full min-h-[320px]">
                  ...
                  {/* Overlay */}
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-linear-to-t from-black/80 via-black/20 to-transparent">
                        ...
                        <tr key={index} className="hover:bg-red-50/30 transition-colors group">
                          ...
                          <td className="px-5 py-4 align-top">
                            <div className="flex flex-col gap-2">
                              <span className={`w-fit text-[10px] px-2 py-0.5 rounded uppercase font-bold border ${group.type === 'online' ? 'bg-blue-50 text-blue-600 border-blue-100' : 'bg-orange-50 text-orange-600 border-orange-100'
                                }`}>
                                {group.type}
                              </span>
