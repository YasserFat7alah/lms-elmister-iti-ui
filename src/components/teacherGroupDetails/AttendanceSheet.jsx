...
import { Check, X, Clock, Save, UserX } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-center bg-gray-50 p-4 rounded-xl border border-gray-100 gap-4 sticky top-0 z-10 shadow-sm">
        ...
        <Button
          ...
          className={`w-full md:w-auto transition-all ${hasChanges
            ? "bg-[#FF4667] hover:bg-[#ff2e53] text-white shadow-md"
            : "bg-gray-200 text-gray-400 cursor-not-allowed"
            }`}
        >
          {isLoading ? <Spinner size={18} className="mr-2" /> : <Save className="mr-2" size={18} />}
                ...
                <div key={student._id} className="p-4 flex flex-col sm:flex-row items-center justify-between gap-4 hover:bg-gray-50 transition">
                  ...
                  <div className="flex bg-gray-100 p-1 rounded-lg w-full sm:w-auto justify-center">
                    <button
                      ...
                      className={`px-4 py-2 rounded-md text-xs font-bold uppercase transition-all flex items-center gap-2 ${status === 'present'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-md text-xs font-bold uppercase transition-all flex items-center gap-2 ${status === 'late'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-md text-xs font-bold uppercase transition-all flex items-center gap-2 ${status === 'absent'
