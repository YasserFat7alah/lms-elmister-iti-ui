    ...
    <form onSubmit={formik.handleSubmit} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <textarea
            name="content"
            className={`w-full min-h-[200px] p-4 rounded-lg border focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none resize-y ${
                formik.errors.content && formik.errors.file ? 'border-red-300 bg-red-50' : 'border-gray-200'
            }`}
        ...
        <div>
          ...
          {!formik.values.file ? (
             // Upload State
             <div className={`border-2 border-dashed rounded-lg p-8 flex flex-col items-center justify-center text-center transition-colors relative ${
                formik.errors.file && formik.errors.content ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:bg-gray-50'
             }`}>
                <input 
                    id="file-upload"
                    type="file" 
