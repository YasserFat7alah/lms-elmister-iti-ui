...
export const apiSlice = createApi({
  ...
  tagTypes: ["User", "Users", "Courses", "Groups", "Lessons", "Teachers", "Children", "Conversation", "Messages", "Assignments", "Submissions", "Enrollment", "NewsletterSubscriber", "NewsletterHistory", "Ticket", "Tickets", "Dashboard"],
  endpoints: (builder) => ({}),
});