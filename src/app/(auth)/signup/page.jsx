          ...
          <Formik initialValues={initialValues} validationSchema={signupSchema} onSubmit={isOauthSession ? handleCompleteProfileSubmit : handleRegisterSubmit} enableReinitialize>
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                {serverError && <div className="text-red-600 text-sm bg-red-50 p-2 rounded">{serverError}</div>}

                <Button type="submit" className="w-full bg-[#FF4667]" disabled={isRegistering || isSubmitting}>
