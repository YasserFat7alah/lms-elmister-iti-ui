...
const PaymentsPage = () => {
  ...
  return (
    <div className="p-8 space-y-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      ...
      {/* CTA Banner */}
      <div className="relative overflow-hidden bg-gradient-to-r from-[#392b80] via-[#5243aa] to-[#6a5acd] rounded-3xl py-6 px-10 text-white shadow-sm hover:shadow-md transition-shadow duration-300">
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link href="/courses">
            <Button className="bg-white text-[#392b80] hover:bg-gray-50 hover:scale-110 active:scale-95 transition-all duration-300 font-bold rounded-full px-10 py-7 shadow-sm border-0 text-lg">
              Surf Our Courses
            </Button>
          </Link>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="bg-white px-8 py-4 rounded-2xl shadow-sm border border-gray-200 flex items-center gap-5 hover:shadow-md hover:scale-105 transition-all duration-300">
      ...
      {!hasEnrollments ? (
        <div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-200">
          ...
          <Link href="/courses">
            <Button className="bg-gradient-to-r from-[#392b80] to-[#6a5acd] hover:from-[#2a2060] hover:to-[#5243aa] text-white shadow-sm hover:shadow-md hover:scale-105 transition-all duration-300 px-8 py-6 rounded-full text-lg font-bold">
              Surf Our Courses
            </Button>
          </Link>
        </div>
        ...
        <div className="space-y-8">
          {children.map(child => (
            child.enrolledCourses && child.enrolledCourses.length > 0 && (
              <div key={child.id} className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300 transform ">
