...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-7xl  space-y-6 pb-10">
      ...
      {/* _________________Profile Banner___________________________ */}
      <Card className="border-none shadow-sm bg-white">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">

            <div className="relative group shrink-0 ">
              <div className="w-28 h-28 rounded-full p-1 border-2 border-white  shadow-sm  bg-white">
                <div className="w-full h-full bg-[#FF0055] rounded-full flex items-center justify-center overflow-hidden relative">
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between">
              ...
              <Link href="/dashboard/parent/profile/changepassword">
