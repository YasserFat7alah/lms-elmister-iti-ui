...
import { 
  ...
  MoreVertical, Clock, Video, Link as LinkIcon, ChevronRight, Loader2, BookOpen 
} from "lucide-react";
...
export default function StudentMaterialsPage() {
  ...
  <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          {lessonsLoading ? (
             <div className="text-center py-10"><Loader2 className="animate-spin mx-auto text-[#FF0055]" /> Loading resources...</div>
