...
import { 
  Video, Calendar, Clock, PlayCircle, AlertCircle, Loader2, Radio, CheckCircle2 
} from "lucide-react";
...
export default function LiveSessionsPage() {
  ...
  if (groupsLoading) return <div className="flex justify-center h-screen items-center"><Loader2 className="animate-spin"/></div>;
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8 min-h-screen pb-20">
      ...
      {liveNow && (
        <div className="animate-in slide-in-from-top-4 duration-500">
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-1 shadow-2xl">
